...
.bar-enter-active, .bar-leave-active { transition: max-height 0.3s ease, opacity 0.3s ease, padding 0.3s ease; overflow: hidden; max-height: 60px; }
.bar-enter-from, .bar-leave-to { max-height: 0; opacity: 0; padding-top: 0; padding-bottom: 0; }
</style>
